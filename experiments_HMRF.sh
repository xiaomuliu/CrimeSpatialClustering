...
do
    ...
    loadfile_feature="./FeatureData/grid_${cellsize[0]}_${cellsize[1]}/cluster_feature_dataframe.pkl"
    ...
    do
        ...
        savepath_cluster="../SharedData/SpatialData/grid_${cellsize[0]}_${cellsize[1]}/cluster/"
        mkdir -p $savepath_cluster
